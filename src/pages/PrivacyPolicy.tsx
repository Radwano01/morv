  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <section className="w-full py-20 px-4 sm:px-6 md:px-20 flex flex-col items-center">
        ...
        {/* Card */}
        <div className="bg-gray-900 rounded-3xl shadow-2xl w-full max-w-4xl p-10 sm:p-14 flex flex-col gap-10 border border-cyan-600/20">
          {/* Title */}
          <h1 className="text-4xl sm:text-5xl font-bold text-[#00caeb] text-center">
            Privacy Policy
          </h1>
          ...
          {/* Scrollable Content with custom dark scrollbar */}
          <div className="text-gray-300 space-y-8 max-h-[650px] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-cyan-600 scrollbar-track-gray-800 scrollbar-thumb-rounded-full scrollbar-track-rounded-full hover:scrollbar-thumb-cyan-400 transition-colors duration-300">
            {/* Sections */}
            {[
              {
                title: "Introduction",
